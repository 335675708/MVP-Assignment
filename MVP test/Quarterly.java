...
public class Quarterly extends FrequencyOfCompounding {
    /**
     * The compounding period value will be multiplied by 4
     * @return compoundingPeriods
     */
    public double getNumberOfCompoundingPeriods(){
        return compoundingPeriods*4;
    } 
    
    /**
     * The interest rate value will be divided by 4
     * @return interestRate
     */
    ...
    public void futureAmount(){
        ...
        label = new JLabel("After investing $" + principleInvested + " for " + compoundingPeriods + " years, at an interest rate of " + (interestRate)*100 + "% that is compounded quarterly, your total amount is $" + finalAnswer);
