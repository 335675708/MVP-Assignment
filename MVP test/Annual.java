...
public class Annual extends FrequencyOfCompounding {
    /**
     * The compounding period value will be multiplied by 1
     * @return compoundingPeriods
     */
    public double getNumberOfCompoundingPeriods(){
        return compoundingPeriods*1;
    } 

    /**
     * The interest rate value will be divided by 1
     * @return interestRate
     */
    ...
    public void futureAmount(){
        ...
        // The calculation for the total future amount
        ...
        // Rounds the answer to the nearest hundredth
        ...
        frame.setVisible(true); // Set the window to be visible and be in focus
    }
    ...
    public void accumulatedInterest(){
        DecimalFormat dFormatter = new DecimalFormat("0.00");
        // The calculation for the accumulated interest
        double answer1 = 1 + getUpdatedInterestRate();
        double answer2 = Math.pow(answer1,getNumberOfCompoundingPeriods());
        double answer3 = principleInvested*answer2; 
